                    ...
                    <tr>
                        ...
                        <form action="{{ route('cart.updateProductIntoCart', $product['item']->id) }}" method="post">
                            ...
                            <td class="actions" data-th="">
                                <button class="btn btn-info btn-sm" type="submit"><i class="fa fa-refresh">Update</i></button>
                                <a class="btn btn-danger btn-sm" href="{{ route('cart.removeProductIntoCart', $product['item']->id) }}">Delete<i class="fa fa-trash-o"></i></a>
                            </td>
                        </form>
                    </tr>
                @endforeach
